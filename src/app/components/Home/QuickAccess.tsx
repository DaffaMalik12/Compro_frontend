...
import { QuickAccessCard } from '../QuickAccessCard'; // Sesuaikan path
import { QuickAccessItem } from '../../types/QuickAccess'; // Sesuaikan path
    ...
    <div className="w-full max-w-7xl mx-auto py-12 px-4">
      ...
      <div className="relative flex items-center">
        ...
        <button
          ...
          className="absolute -right-4 md:-right-6 top-      {/* Indikator Titik */}
1/2 -translate-y-1/2 z-20  bg-yellow-500 hover:bg-yellow-700 text-white  p-3 rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 border disabled:opacity-50 disabled:cursor-not-allowed"
